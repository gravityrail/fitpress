...
class FitBitPHP
{
    ...
    {
        $this->baseApiUrl = ($httpsApi ? 'https://' : 'http://') . $this->apiHost . '/1/';
            
        $url_prefix = $https ? 'https://' : 'http://';
        $this->authUrl = $url_prefix . $this->authHost . '/oauth/authorize';
    ...
    {
        // error_log($_SESSION['fitbit_Session']);
